...
export const ShuffleTrack = (props: any) => {
  return (
    <button
      title="shuffle"
      onClick={props.shuffleTrack}
      className="rounded-sm p-1 text-slate-200 hover:text-slate-50"
    >
      <svg
        style={{
          color: props.isShuffling ? props.currentColor.text : "#fff",
        }}
        className={cx("h-5 w-5 fill-neutral-100",
        { "fill-orange-400" : props.isLooping === true }
      )}
        fill="currentColor"
