  ...
  renderCurrentSong() {
    return (
      <div className='flex justify-center py-4 '>
        <p className='border border-zinc-500/40 rounded-xl px-2 py-2'>
...
// change volume
  ...
  render() {
    ...
    const setShuffleState = shuffleState => this.setState({ shuffleState });
    
    const shuffleTrack = () => { setShuffleState(!shuffle); };
    ...
    return (
      <div className='font-semibold rounded-xl bg-zinc-800/80 text-neutral-100/80 border-orange-200 '>
        <div className="flex justify-center items-center rounded-xl bg-zinc-500 px-2 py-2">
        ...
        <PlayerControls
          ...
          onVolume={volume}
          onShuffle={shuffle}
          onShuffleTrack= {this.setState({ shuffle: !shuffle })}
          onFinishedPlaying={handleAudioEnded}       
          />
          <SongSelector
          songs={songs}
